<div class="form-group">
	...
	<div class="col-sm-10">
		{!! Form::text('nama_kesenian',null,['class'=>'form-control','id'=>'nama_kesenian','placeholder'=>"Nama"]) !!}
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		{!! Form::select('id_suku1',$suku->listsuk('nama_suku','id_suku'),null,['class'=>'form-control','id'=>'id','placeholder'=>"[suku]"]) !!}
	</div>
</div>
